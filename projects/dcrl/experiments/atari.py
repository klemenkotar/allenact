...
from allenact_plugins.gym_plugin.gym_models import ContrastiveConvolutionalActorCritic
from allenact_plugins.gym_plugin.gym_sensors import GymAtariSensor
...
class GymTutorialExperimentConfig(ExperimentConfig):
    ...
    # %%
    SENSORS = [
        GymAtariSensor(uuid="gym_atari_frame"),
    ]
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return ContrastiveConvolutionalActorCritic(
            input_uuid="gym_atari_frame",
    ...
    @staticmethod
    def _make_atari_wrapper(env):
        return AtariPreprocessing(env, grayscale_obs=False)
    ...
    def machine_params(cls, mode="train", **kwargs) -> Dict[str, Any]:
        ...
        return {
            "nprocesses": 32 if mode == "train" else 1,
